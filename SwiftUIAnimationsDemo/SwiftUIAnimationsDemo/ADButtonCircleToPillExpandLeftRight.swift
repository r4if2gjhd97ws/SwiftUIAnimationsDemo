//
//  ButtonCircleToPillExpandLeftRight.swift
...
class ADButtonCircleToPillExpandLeftRightViewModel: ObservableObject {
...
struct ADButtonCircleToPillExpandLeftRight: View {
  @StateObject var model: ADButtonCircleToPillExpandLeftRightViewModel
...
struct ADButtonCircleToPillExpandLeftRight_Previews: PreviewProvider {
  static var previews: some View {
    ZStack {
      Color(.gray)
      
      ADButtonCircleToPillExpandLeftRight()
    }
  }
}
